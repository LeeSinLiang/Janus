...
DATABASES = {
    "default": {
        ...
        # Connection pooling settings for better thread handling
        "CONN_MAX_AGE": 0,  # Close connections immediately after request (good for SQLite + threads)
    }
}
...
# Trust frontend origin for CSRF
