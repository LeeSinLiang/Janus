      ...
      <div className="space-y-3">
        ...
        <div className="flex gap-3">
          ...
          <div className="flex-1 rounded-lg border border-purple-200 bg-purple-50 p-3">
            ...
            <div
              className={`text-xs font-medium ${
                isPositive(replyPercentage) ? 'text-green-600' : 'text-red-600'
              }`}
            >
              <span className="mr-1">
                {isPositive(replyPercentage) ? '↑' : '↓'}
              </span>
              {replyPercentage.replace('-', '')} vs last 24 hours
            </div>
          </div>
          ...
          <div className="flex-1 rounded-lg border border-purple-200 bg-purple-50 p-3">
            ...
            <div
              className={`text-xs font-medium ${
                isPositive(retweetPercentage) ? 'text-green-600' : 'text-red-600'
              }`}
            >
              <span className="mr-1">
                {isPositive(retweetPercentage) ? '↑' : '↓'}
              </span>
              {retweetPercentage.replace('-', '')} vs last 24 hours
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-3">
          ...
          <div className="flex-1 rounded-lg border border-purple-200 bg-purple-50 p-3">
            ...
            <div
              className={`text-xs font-medium ${
                isPositive(likePercentage) ? 'text-green-600' : 'text-red-600'
              }`}
            >
              <span className="mr-1">
                {isPositive(likePercentage) ? '↑' : '↓'}
              </span>
              {likePercentage.replace('-', '')} vs last 24 hours
            </div>
          </div>
          ...
          <div className="flex-1 rounded-lg border border-purple-200 bg-purple-50 p-3">
            ...
            <div
              className={`text-xs font-medium ${
                isPositive(viewPercentage) ? 'text-green-600' : 'text-red-600'
              }`}
            >
              <span className="mr-1">
                {isPositive(viewPercentage) ? '↑' : '↓'}
              </span>
              {viewPercentage.replace('-', '')} vs last 24 hours
            </div>
          </div>
        </div>
      </div>
